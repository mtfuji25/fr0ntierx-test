...
contract('WyvernExchange-NFT-Purchase', (accounts) => {
    ...
    it('purchase ERC721 NFT with ETH', async () => {
        ...
        // atomicMatchWith needs to be called by the nftBuyer since the buyer needs to pay the ETH
        ...
        assert.equal(sellerFinalEthBalanceBN.sub(sellerInitialEthBalanceBN), buyingPrice, 'Incorrect amount of ETH transferred')
    })
})
