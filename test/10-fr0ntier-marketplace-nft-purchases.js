...
contract('Fr0ntier-Marketplace-NFT-Purchases', (accounts) => {
    ...
    it('purchase ERC721 NFT with ETH', async () => {
        ...
        // tradeNFT needs to be called by the nftBuyer since the buyer needs to pay the ETH
        ...
        // console.log("buyerFr0ntierBalance:                    ", buyerFr0ntierBalance.toString())
        // console.log("sellerFr0ntierBalance:                   ", sellerFr0ntierBalance.toString())
