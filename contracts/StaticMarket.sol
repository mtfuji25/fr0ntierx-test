...
contract StaticMarket {
    ...
    function ERC721ForETH(
        ...
        uint256 msgValue = uints[0];
        require(msgValue > 0, "ERC721ForETH: value needs to be positive");
        require(
            howToCalls[0] == AuthenticatedProxy.HowToCall.Call,
            "ERC721ForETH: call must be a direct call"
        );
        ...
        uint256 price = tokenIdAndPrice[1];
        require(
            price > 0,
            "ERC721ForETH: ERC721 price must be larger than zero"
        );
        require(
            msgValue == price,
            "ERC721ForETH: ERC721 price must be equal to msgValue"
        );
        require(
            tokenGiveGet[1] == address(0),
            "ERC721ForETH: payment needs to be in ETH"
        );
        require(
            addresses[2] == tokenGiveGet[0],
            "ERC721ForETH: call target must equal address of token to give"
        );
        require(
            addresses[5] == tokenGiveGet[1],
            "ERC721ForETH: countercall target must equal address of token to get"
        );
    ...
    function ETHForERC721(
        ...
        require(
            howToCalls[0] == AuthenticatedProxy.HowToCall.Call,
            "ETHForERC721: call must be a direct call"
        );
        ...
        require(
            price > 0,
            "ETHForERC721: ERC721 price must be larger than zero"
        );
        require(
            msgValue == price,
            "ETHForERC721: ERC721 price must be equal to msgValue"
        );
        require(
            tokenGiveGet[0] == address(0),
            "ETHForERC721: payment needs to be in ETH"
        );
        require(
            addresses[2] == tokenGiveGet[0],
            "ETHForERC721: call target must equal address of token to give"
        );
        require(
            addresses[5] == tokenGiveGet[1],
            "ETHForERC721: countercall target must equal address of token to get"
        );
