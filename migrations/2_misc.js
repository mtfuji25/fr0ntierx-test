...
const MockFr0ntierToken = artifacts.require('./MockFr0ntierToken.sol')
...
module.exports = async (deployer, network) => {
  ...
  await deployer.deploy(MockFr0ntierToken)
  ...
  if (network !== 'development') {
    ...
    setConfig('deployed.' + network + '.MockFr0ntierToken', MockFr0ntierToken.address)
  }
}
